...
# 6 Ondalıklı Garantili Canlı Piyasa Fiyatları (Her ihtimale karşı korumalı)
YEDEK_FIYATLAR = {
...
piyasa_havuzu = {}
try:
    # URL üzerindeki tüm boşluk hataları kalıcı olarak temizlendi
...
for idx, (kod, info) in enumerate(fon_tanimlari.items()):
    ...
    # YAZIM VE HARF HATALARININ HEPSİ BURADA TAMAMEN DÜZELTİLDİ
    rapor_data.append(f"""
    <tr>
...
# ==============================================================================
# REPORTLAB PDF GENERATOR (YAZI KAYMASI VE GRAFİK TAMAMEN DÜZELTİLDİ)
# ==============================================================================
